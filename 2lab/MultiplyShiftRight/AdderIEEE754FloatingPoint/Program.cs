...
namespace AdderIEEE754FloatingPoint
{
    class Program
    {
        static void Main(string[] args)
        {
            IEEE754 num1 = new IEEE754("-20");
            Console.WriteLine("-20 {0}", num1.ToString());
            IEEE754 num2 = new IEEE754("145");
            Console.WriteLine("145 {0}", num2.ToString());

            IEEE754 result = new IEEE754("125");
            Console.WriteLine("125 {0}", result.ToString());
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("Start of a program");
            Console.WriteLine();
            ...
            num1 = new IEEE754("50");
            Console.WriteLine("50 {0}", num1.ToString());
            num2 = new IEEE754("73");
            Console.WriteLine("73 {0}", num2.ToString());
    ...
    public class IEEE754
    {
        ...
        public IEEE754(string number, int expLength, int fracLength)
        {
            ...
            {
                if (number.Contains("-")) InfinityNegative();
                else Infinity();
            }
            else
            {
                float num = 0;
                bool notNAN = Single.TryParse(number, out num);

                if (notNAN) ConvertFloatToIEE754(num);
                else MakeNaN();
            }
        }
        private void InfinityNegative()
        {
            Sign = 1;
            Normalized = 0;
        ...
        public IEEE754 Add(IEEE754 first, IEEE754 second)
        {
            ...
            Console.WriteLine($"Mantissa of second number (shifted):  {second.ToString()}");

            if (first.Sign == second.Sign)
            {
                Console.WriteLine("Equal signs");
            ...
            {
                Console.WriteLine("Unequal signs");
